package com.topdown.game.desktop;
...
import com.topdown.game.TopDownServer;
import com.topdown.game.TopDownClient;
...
public class DesktopLauncher implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!server) {
			game = new TopDownClient();
		} else {
			game = new TopDownServer();
		}
		// Testing purposes
		// ---------------------------
		fullscreen = false;
